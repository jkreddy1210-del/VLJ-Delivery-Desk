...
const deliveryChallanSchema = z.object({
  ...
  movementReason: z.enum(["ORIGINAL", "RETURN", "REPLACEMENT", "OTHER"]).optional(),
  againstVoucherNo: optionalText,
  invoiceNo: optionalText,
  noteType: z.enum(["CREDIT", "DEBIT"]).optional().nullable(),
  noteNo: optionalText,
...
const deliveryChallanListSchema = z.object({
  ...
  direction: z.enum(["ALL", "INWARD", "OUTWARD"]).default("ALL"),
